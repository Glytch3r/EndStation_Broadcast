...
-- CATEGORIES:
-- Undefined    Default category if none is set.
-- Radio    Standard civilian radio channels (e.g., music, talk shows).
-- Television    Used for TV broadcasts.
-- Military    Military frequencies (e.g., coded transmissions).
-- Amateur    Used for player roleplay or lore-friendly survivor communications.
